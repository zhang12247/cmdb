# Generated by Django 2.1.7 on 2019-04-09 13:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cpu_core_count', models.PositiveSmallIntegerField(default=1, verbose_name='CPU核心')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True, verbose_name='事件事件')),
                ('memo', models.TextField(blank=True, null=True, verbose_name='备注')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('intranet_ip', models.GenericIPAddressField(blank=True, null=True, verbose_name='网络设备型号')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='assets.Asset')),
                ('hostd_on', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='hosted_on_server', to='assets.Server', verbose_name='宿主机')),
            ],
            options={
                'verbose_name': '服务器',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('version', models.CharField(help_text='例如：CentOS release 6.7(finial)', max_length=64, unique=True, verbose_name='软件\\系统版本')),
            ],
            options={
                'verbose_name': '软件\\系统',
        ...
        migrations.AddField(
            model_name='eventlog',
            name='new_asset',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assets.NewAssetApprovalZone'),
        ),
        migrations.AddField(
            model_name='eventlog',
            name='user',
        ...
        migrations.AddField(
            model_name='asset',
            name='manufacturer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='assets.Manufacture', verbose_name='制造商'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tags',
